...
public class MyService extends Service {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case GET_RANDOM_NUMBER_FLAG:
                    // Its Like Adddress Mail Send
                    // Get Message
                    Message messageSendRandomNumber = Message.obtain(null, GET_RANDOM_NUMBER_FLAG);
                    messageSendRandomNumber.arg1 = getRandomNumber();  // Set Value

                    try {
                        msg.replyTo.send(messageSendRandomNumber);   // Send Back to Messenger
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i(TAG, "Service Flag : " + Service.START_FLAG_REDELIVERY);
